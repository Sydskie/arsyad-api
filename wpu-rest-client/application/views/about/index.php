  ...
  <!-- Portfolio -->
      <section class="portfolio" id="portfolio">
          <div class="row">
            ...
            <div class="col-md mb-4">
              <div class="card">
                <img class="card-img-top" src="<?= base_url(); ?>assets/img/thumbs/tampilan pizza.png" alt="Card image cap">
                <div class="card-body">
                  <h5>WPU-HUT</h5>
            ...
            <div class="col-md mb-4">
              <div class="card">
                <img class="card-img-top" src="<?= base_url(); ?>assets/img/thumbs/tampilan movie.png" alt="Card image cap">
                <div class="card-body">
                  <h5>WPU-MOVIE</h5>
